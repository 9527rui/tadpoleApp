package com.DaZhouvocationalandTechnicalCollege.helloworld.motion_app.Record;
...
public final class DatePickerTimeline extends LinearLayout implements MonthView.OnMonthSelectedListener {
    ...
    private void init(AttributeSet attrs, int defStyleAttr) {
        ...
        monthView.setBackgroundColor(getResources().getColor(R.color.mti_default_primary));
        monthView.setFirstDate(startYear, startMonth);
        monthView.setDefaultColor(getResources().getColor(R.color.mti_default_primary_dark));
